...
import './ReflectedAttack.css';
import NavButtons from '../NavButtons/NavButtons';

const ReflectedAttack = ({setSubjectNum, setPageNum, setExplanations, setIsReflected, isReflected, nextLevel, lastLevel}) => {
    ...
    <div className="ReflectedAttack">
        ...
        <div className="questionCard">
            ...
            <div className="answers">
                ...
                {isRight ?
                    <button className="correct answer answer2">
                        <img src={searchIcon} className="search icon"/>
                        {string1}
                        <img src={starIcon} className="star icon"/>
                    </button>
                    :
                    <button className="answer2 answer" onClick={() => setIsRight(true)}>
                        <img src={searchIcon} className="search icon"/>
                        {string1}
                        <img src={starIcon} className="star icon"/>
                    </button>
                ...
                {isWrong2 ? <button className="answer3 answer wrong">
                    <img src={searchIcon} className="search icon"/>
                    {string3}
                    <img src={starIcon} className="star icon"/>
                </button> : <button className="answer3 answer" onClick={() => setIsWrong2(true)}>
                    <img src={searchIcon} className="search icon"/>
                    {string3}
                    <img src={starIcon} className="star icon"/>
                </button>}

                {isWrong3 ? <button className="answer4 answer wrong">
                    <img src={searchIcon} className="search icon"/>
                    {string4}
                    <img src={starIcon} className="star icon"/>
                </button> : <button className="answer4 answer" onClick={() => setIsWrong3(true)}>
                    <img src={searchIcon} className="search icon"/>
                    {string4}
                    <img src={starIcon} className="star icon"/>
                </button>}
...
export default ReflectedAttack
